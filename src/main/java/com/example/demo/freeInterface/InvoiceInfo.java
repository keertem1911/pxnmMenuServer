...
public class InvoiceInfo {
    ...
    private String amount;//发票总额度
    private String attribute1;//会计科目
    private String attribute10="pxsystem";//培训系统标识字段
    private String attribute2;//公司代码
    private String attribute3;//法务合同号
    ...
    private String bizDesc;//业务说明
    @XmlElement(name = "biz_end_date")
    private String bizEndDate;//业务结束日期
    @XmlElement(name = "biz_start_date")
    private String bizStartDate;//业务开始日期
    @XmlElement(name = "biz_type")
    private String bizType;//业务类型
    @XmlElement(name = "business_types")
    private String businessTypes;//业务种类
    @XmlElement(name = "company_id")
    private String companyId;//利润中心
    ...
    private String theTaxCode;//税码
    @XmlElement(name = "vendor_id")
    private int vendorId;//供应商编号
    @XmlElement(name = "write_off")
    private String writeOff;//冲销
    private String ywlwxz;//业务来往性质
